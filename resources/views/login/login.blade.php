        ...
        <div class="row justify-content-center">
          ...
          <form>
            <div class="form-group">
                <input type="nama" class="form-control mb-4" id="exampleFormControlInput1" placeholder="Email">
                <input type="email" class="form-control mb-4" id="exampleFormControlInput1" placeholder="Password">
            </form>
