          ...
          <div class="col-lg-7 mt-3">
            <form>
                <div class="form-group">
                    <input type="nama" class="form-control mb-2" id="exampleFormControlInput1" placeholder="Nama">
                    <input type="email" class="form-control mb-2" id="exampleFormControlInput1" placeholder="Email">
                    <input type="telepon" class="form-control mb-2" id="exampleFormControlInput1" placeholder="No Telepon">
                </div>
                    <div class="form-group">
                    <textarea class="form-control mb-2" id="exampleFormControlTextarea1" rows="3" placeholder="Isi Pesan"></textarea>
                </div>
            </form>
